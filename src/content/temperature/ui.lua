function create_uibox_opal_temperature() -- Temperature UI reworked
    ...
    G.opal_indicators = G.opal_indicators or CardArea(0,0,2.1,0.5,{card_limit = 1, highlight_limit = 0, type = 'opal_mods', opal_type = 'square', opal_per_row = 4})
    ...
    if not G.GAME.modifiers.opal_no_mods then
        G.opal_heat_mods = G.opal_heat_mods or CardArea(0,0,2.1,0.5,{card_limit = 1, highlight_limit = 0, type = 'opal_mods', opal_type = G.opal_mod_shape == 1 and 'hex' or 'square',  opal_per_row = G.opal_mod_size == 2 and 3 or 4})
